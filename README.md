...
```
[htseng@datahub]$ git clone https://github.com/cs203ucsd/2024fa-cs203-performance-hungweitseng.git
...
fatal: Authentication failed for 'https://github.com/cs203ucsd/2024fa-cs203-performance-hungweitseng.git/'
```
